...
const CustomButtonFrame = styled(XStack, {
  ...
  variants: {
    ...
    // TODO: change variant name back to `disabled` https://linear.app/uniswap/issue/WEB-6347/revert-ThreeDbutton-disabled-variant-name-change-following-tamagui
    isDisabled: {
      true: {
        pointerEvents: 'none',
        userSelect: 'none',
...
/** @ThreeD Please use `Button` from `ui/src` */
